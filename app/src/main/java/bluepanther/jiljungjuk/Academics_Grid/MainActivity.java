package bluepanther.jiljungjuk.Academics_Grid;
...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.academic_main);
        Firebase.setAndroidContext(this);
        fb_db=new Firebase(Base_url);
        progressBar = new ProgressBar(this);
        tar="GROUP";
        if(this.getIntent().getExtras().getBoolean("bool1")) {
            Category.maincat = "Academics";
            Category.subcat = "Time Table";
        }
        /**
...
//                    xfragmentTransaction.replace(R.id.containerView,new Text()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_textbooks) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    fragmentTransaction.replace(R.id.containerView,new Audio()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_testschedule) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    xfragmentTransaction.replace(R.id.containerView,new Text()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_testmarks) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    fragmentTransaction.replace(R.id.containerView,new Audio()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_questionpapers) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    fragmentTransaction.replace(R.id.containerView,new Audio()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_examschedule) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    xfragmentTransaction.replace(R.id.containerView,new Text()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_exammarks) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    fragmentTransaction.replace(R.id.containerView,new Audio()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_assignments) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    xfragmentTransaction.replace(R.id.containerView,new Text()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_observation) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    xfragmentTransaction.replace(R.id.containerView,new Text()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_lateattendance) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
            ...
            public void onCentreButtonClick() {
                ...
                switch (FindTab.curTab)
                {
                    ...
                    case "Audio":
                        ...
                        {
                            Toast.makeText(MainActivity.this,"No audio selected",Toast.LENGTH_SHORT).show();
                        }
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            if (stringBuilder.toString().trim().equals("")) {
                                                ...
                                                Toast.makeText(MainActivity.this,"Contacts selected",Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
