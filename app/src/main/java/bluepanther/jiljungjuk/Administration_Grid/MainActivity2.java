package bluepanther.jiljungjuk.Administration_Grid;
...
public class MainActivity2 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.administration_main);
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.nav_registration) {
                    ...
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
...
//                    fragmentTransaction.replace(R.id.containerView,new Audio()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_feepayment) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    xfragmentTransaction.replace(R.id.containerView,new Text()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_uniform) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    fragmentTransaction.replace(R.id.containerView,new Audio()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_shoes_accessories) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    xfragmentTransaction.replace(R.id.containerView,new Text()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_functions) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    fragmentTransaction.replace(R.id.containerView,new Audio()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_visitors_specialguests) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    xfragmentTransaction.replace(R.id.containerView,new Text()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_speciallectures) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    fragmentTransaction.replace(R.id.containerView,new Audio()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_certificates) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    xfragmentTransaction.replace(R.id.containerView,new Text()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_holidays) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    fragmentTransaction.replace(R.id.containerView,new Audio()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_scholarships) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
...
//                    xfragmentTransaction.replace(R.id.containerView,new Text()).commit();
                ...
                if (menuItem.getItemId() == R.id.nav_circulars) {
                    System.out.println("PETTA RAP = " + menuItem.toString());
                    selectcat = menuItem.toString();
                    Toast.makeText(MainActivity2.this, "" + menuItem, Toast.LENGTH_SHORT).show();
                    TempClass.sharedValue = menuItem.toString();
            ...
            public void onCentreButtonClick() {
                ...
                switch (FindTab.curTab)
                {
                        ...
                        if(Uploader.istate) {
                            ...
                            up.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    notificationBuilder.setProgress(100, (int) progress, false).setContentText("Progressed (" + (int) progress + "%)").setOngoing(false);
                                    notification = notificationBuilder.build();
                                    notificationManager.notify(100, notification);
                    ...
                    case "Audio":
                        if(Uploader.astate) {
                            ...
                            up1.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    notificationBuilder2.setProgress(100, (int) progress2, false).setContentText("Progressed (" + (int) progress2 + "%)").setOngoing(false);
                                    notification2 = notificationBuilder2.build();
                                    notificationManager2.notify(101, notification2);
                        ...
                        {
                            Toast.makeText(MainActivity2.this,"No audio selected",Toast.LENGTH_SHORT).show();
                        }
                    ...
                    case "Video":
                        if(Uploader.vstate) {
                            ...
                            up2.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    progress3 = (100.0 * taskSnapshot.getBytesTransferred()) / taskSnapshot.getTotalByteCount();
                                    System.out.println("Progress is " + progress3);
                                    notificationBuilder3.setProgress(100, (int) progress3, false).setContentText("Progressed (" + (int) progress3 + "%...)").setOngoing(false);
                                    notification3 = notificationBuilder3.build();
                                    notificationManager3.notify(102, notification3);
                                    Uploader.vstate=false;
                                    Toast.makeText(getApplicationContext(), "Video Uploaded", Toast.LENGTH_LONG).show();
                                    Intent i4 = new Intent(MainActivity2.this, MainActivity2.class);
                        ...
                        {
                            Toast.makeText(MainActivity2.this,"No video selected",Toast.LENGTH_SHORT).show();
                        }
                    ...
                    case "File":
                        if(Uploader.fstate) {
                            ...
                            up3.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    notificationBuilder4.setProgress(100, (int) progress4, false).setContentText("Progressed (" + (int) progress4 + "%)").setOngoing(false);
                                    notification4 = notificationBuilder4.build();
                                    notificationManager4.notify(104, notification4);
                                    Uploader.fstate=false;
                                    Toast.makeText(MainActivity2.this, "File Uploaded", Toast.LENGTH_LONG).show();
                                    Intent i5 = new Intent(MainActivity2.this, MainActivity2.class);
                        ...
                        {
                            Toast.makeText(MainActivity2.this,"No file selected",Toast.LENGTH_SHORT).show();
                        }
...
//                            // Intialize  readable sequence of char values
                    ...
                    fb_db2.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            final AlertDialog.Builder builderDialog = new AlertDialog.Builder(MainActivity2.this);
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            if (stringBuilder.toString().trim().equals("")) {
                                                Toast.makeText(MainActivity2.this,"No contact selected",Toast.LENGTH_SHORT).show();

                                            } else {
                                                Toast.makeText(MainActivity2.this,"Contacts selected",Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
...
//                            // Intialize  readable sequence of char values
        ...
        spaceNavigationView.setSpaceOnLongClickListener(new SpaceOnLongClickListener() {
            ...
            public void onCentreButtonLongClick() {
                Toast.makeText(MainActivity2.this, "onCentreButtonLongClick", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onItemLongClick(int itemIndex, String itemName) {
                Toast.makeText(MainActivity2.this, itemIndex + " " + itemName, Toast.LENGTH_SHORT).show();
            }
        });
    }
}