...
import bluepanther.jiljungjuk.recycler.CustomAdapterGR;
...
public class Repgroup_tab extends Fragment {
    static String file1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        context=getActivity();
        myOnClickListener = new Repgroup_tab.MyOnClickListener(getActivity());
        
        return parentView;
    }
    public static void setContent(CustomAdapterGR adapter)
    {
    ...
    private static class MyOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (RepContent.grpcontent.get(position).getType().equals("Images")) {
                ...
                final String res = RepContent.grpcontent.get(position).getAuthor() + RepContent.grpcontent.get(position).getTime();
...
progressDialog.dismiss();
            ...
            if (RepContent.grpcontent.get(position).getType().equals("Audios")) {
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
            ...
            if (RepContent.grpcontent.get(position).getType().equals("Videos")) {
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
            ...
            if (RepContent.grpcontent.get(position).getType().equals("Files")) {
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
            ...
            if (RepContent.grpcontent.get(position).getType().equals("Text")) {
