...
public class CustomAdapterGT extends RecyclerView.Adapter<CustomAdapterGT.MyViewHolder> {

 //   private ArrayList<DataModel> dataSet;
    public static Group_tab mainActivity;
    Context context;
    ...
    public CustomAdapterGT(Context context, List<RowItem> rowItems) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(Group_tab.myOnClickListener);
                                                                              ...
                                                                              try {
                                                                                  ...
                                                                                  storageReference.getFile(files).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                                                                                      ...
                                                                                      public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                                                                          ...
                                                                                          context.startActivity(Intent.createChooser(sharingIntent, "Share content using").setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));// "Share image using").setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
                                                                              ...
                                                                              try {
                                                                                  ...
                                                                                  storageReference.getFile(files).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                                                                                      ...
                                                                                      public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                                                                          ...
                                                                                          sharingIntent.putExtra(Intent.EXTRA_STREAM, screenshotUri);
                                                                                          context.startActivity(Intent.createChooser(sharingIntent, "Share content using").setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));// "Share Audio using").setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
                                                                                    //      progressDialog.dismiss();
...
//                                                                                  progressDialog.show();
                                                                                  ...
                                                                                  storageReference.getFile(files).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                                                                                      ...
                                                                                      public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                                                                          ...
                                                                                          context.startActivity(Intent.createChooser(sharingIntent, "Share content using").setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));// "Share Video using").setFlags(Intent.FLAG_ACTIVITY_NEW_TASK) );
                                                                                     //     progressDialog.dismiss();
...
//                                                                                  progressDialog.show();
                        ...
                        break;
                    case 1:
                        System.out.println("the pos is "+listPosition);
                        if (TimeContent.grpcontent.get(listPosition).getType().equals("Text")) {
                            ...
                            try {
                                ...
                                if (f.exists()) {
                                    ...
                                    for (int j = 0; j < textcontent.size(); j++) {
                                        if (textcontent.get(j).getMember_name().equals(TimeContent.grpcontent.get(listPosition).getMember_name())) {
                                    ...
                                    CustomAdapterGT adapter = new CustomAdapterGT(context, grpcontent);
                        ...
                        else if (TimeContent.grpcontent.get(listPosition).getType().equals("Images")) {
                            ...
                            try {
                                ...
                                if (f.exists()) {
                                    ...
                                    for (int k = 0; k < textcontent.size(); k++) {
                                        System.out.println("List iteams are nows" + textcontent.get(k).getMember_name());
                                    }
                        ...
                        else if (TimeContent.grpcontent.get(listPosition).getType().equals("Audios")) {
                        ...
                        else if (TimeContent.grpcontent.get(listPosition).getType().equals("Videos")) {
                        ...
                        else if (TimeContent.grpcontent.get(listPosition).getType().equals("Files")) {
