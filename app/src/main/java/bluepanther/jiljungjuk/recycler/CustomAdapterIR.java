...
public class CustomAdapterIR extends RecyclerView.Adapter<CustomAdapterIR.MyViewHolder> {

 //   private ArrayList<DataModel> dataSet;
    public static Repindi_tab mainActivity;
    Context context;
    String file1;
    ...
    public CustomAdapterIR(Context context, List<RowItem> rowItems) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(Repindi_tab.myOnClickListener);
