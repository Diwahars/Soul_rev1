...
import bluepanther.jiljungjuk.Indi_tab;
import bluepanther.jiljungjuk.Proindi_tab;
import bluepanther.jiljungjuk.R;
import bluepanther.jiljungjuk.RowItem;
import bluepanther.jiljungjuk.RowItemPro;
import bluepanther.jiljungjuk.TimeContent;


public class CustomAdapterIP extends RecyclerView.Adapter<CustomAdapterIP.MyViewHolder> {

 //   private ArrayList<DataModel> dataSet;
    public static Proindi_tab mainActivity;
    Context context;
    String file1;
    List<RowItemPro> rowItems;
    ...
    public CustomAdapterIP(Context context, List<RowItemPro> rowItems) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(Proindi_tab.myOnClickListener);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
        ...
        RowItemPro row_pos = rowItems.get(listPosition);
