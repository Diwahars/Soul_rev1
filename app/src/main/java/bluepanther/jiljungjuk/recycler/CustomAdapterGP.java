...
import bluepanther.jiljungjuk.Progroup_tab;
...
public class CustomAdapterGP extends RecyclerView.Adapter<CustomAdapterGP.MyViewHolder> {

 //   private ArrayList<DataModel> dataSet;
    public static Progroup_tab mainActivity;
    Context context;
    String file1;
    ...
    public CustomAdapterGP(Context context, List<RowItemPro> rowItems) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(Progroup_tab.myOnClickListener);
