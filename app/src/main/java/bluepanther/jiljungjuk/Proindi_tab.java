...
import bluepanther.jiljungjuk.recycler.CustomAdapterIP;
import bluepanther.jiljungjuk.recycler.CustomAdapterIT;

/**
 * Created by shyamjoval on 1/16/2017.
 */

public class Proindi_tab extends Fragment {
    static String file1;
    ...
    public CustomAdapterIP adapter2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter2 = new CustomAdapterIP(getActivity(), ProContent.percontent);
        Firebase.setAndroidContext(getActivity());
        fb_db = new Firebase(Base_url);
        mylistview2.setAdapter(adapter2);
        context=getActivity();
        myOnClickListener = new Proindi_tab.MyOnClickListener(getActivity());


       
        return parentView;
    }
    public static void setContent(CustomAdapterIP adapter)
    {
    ...
    private static class MyOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
                ...
                if (ProContent.percontent.get(position).getType().equals("Images")) {
                    ...
                    final String res = ProContent.percontent.get(position).getOwner() + ProContent.percontent.get(position).getTime();
...
progressDialog.dismiss();
                ...
                if (ProContent.percontent.get(position).getType().equals("Audios")) {
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
                ...
                if (ProContent.percontent.get(position).getType().equals("Videos")) {
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
                ...
                if (ProContent.percontent.get(position).getType().equals("Files")) {
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
                ...
                if (ProContent.percontent.get(position).getType().equals("Text")) {
