...
import bluepanther.jiljungjuk.recycler.*;

import static bluepanther.jiljungjuk.ImgUri.uri;

/**  l
 * Created by shyamjoval on 1/16/2017.
 */

public class Group_tab extends Fragment {
   ...
   static String file1;
    ...
    public static CustomAdapterGT adapter;
  static  public String Base_url = "https://soul-for-schools.firebaseio.com/";
   ...
   public  static View.OnClickListener myOnClickListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new CustomAdapterGT(getActivity(), TimeContent.grpcontent);
        ...
        myOnClickListener = new Group_tab.MyOnClickListener(getActivity());

        return parentView;
    }
    public static void setContent(CustomAdapterGT adapter)
    {
    ...
    private  static class MyOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (TimeContent.grpcontent.get(position).getType().equals("Images")) {
                ...
                final String res = TimeContent.grpcontent.get(position).getAuthor() + TimeContent.grpcontent.get(position).getTime();
            ...
            if (TimeContent.grpcontent.get(position).getType().equals("Audios")) {
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
            ...
            if (TimeContent.grpcontent.get(position).getType().equals("Videos")) {
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
            ...
            if (TimeContent.grpcontent.get(position).getType().equals("Files")) {
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
            ...
            if (TimeContent.grpcontent.get(position).getType().equals("Text")) {
